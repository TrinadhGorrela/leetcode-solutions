 ...
 * Key insight: Count every character in the text; "balloon" needs b=1, a=1, l=2, o=2, n=1—so the answer is
 ...
 *
 * Edge Cases Handled: missing any required letter (returns 0), odd count of 'l' or 'o' (integer division floors
 * correctly), text contains no letters from "balloon"
 */
