 ...
 * Key insight: Express fib(n) directly as the sum fib(n-1) + fib(n-2) with base cases 0 and 1; every call re-expands into two subproblems, so no result is memoized and the work grows exponentially.
 *
