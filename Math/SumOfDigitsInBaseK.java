 ...
 * Key insight: Peel off the least significant base-k digit via n % k, accumulate it, then integer-divide n by k; repeat
 ...
 *
 * Edge Cases Handled: n = 0 (loop never executes, returns 0), k > n (single digit returned as-is), k = 2 (binary digit
 * sum)
 */
