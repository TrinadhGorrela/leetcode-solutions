 ...
 * Key insight: Advance slow by one and fast by two; when fast reaches the end, slow is at the second middle (for
 * even-length lists) because it traveled exactly half the distance.
 *
