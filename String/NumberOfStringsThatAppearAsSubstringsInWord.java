 ...
 * Key insight: For each pattern in the array, use String.contains() to test if it appears as a substring of word;
 ...
 *
 * Edge Cases Handled: pattern equal to word (match), pattern longer than word (no match), empty pattern list, duplicate
 * patterns (each counted independently)
 */
