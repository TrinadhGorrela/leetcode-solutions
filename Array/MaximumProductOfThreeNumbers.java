 ...
 * Key insight: After sorting, the maximum 3-product is either the three largest positives (tail) or the two
 * most-negative values times the largest positive (two negatives yield a positive product).
 *
 ...
 *
 * Edge Cases Handled: two large negatives times a positive beats three positives, all-negative arrays, zeros in the
 * middle, exactly three elements (both candidates overlap)
 */
