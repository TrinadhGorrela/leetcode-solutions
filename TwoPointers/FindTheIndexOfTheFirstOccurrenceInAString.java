 ...
 * Key insight: Slide a window of length M across the N-length haystack; at each position, compare character-by-character and break early on mismatch—simple but avoids the complexity of KMP/Boyer-Moore for interviews.
 *
 ...
 *
 * Edge Cases Handled: Needle longer than haystack (early -1 return), needle equal to haystack (exact match), needle at position 0, needle at last valid position, no match anywhere in haystack
 */
