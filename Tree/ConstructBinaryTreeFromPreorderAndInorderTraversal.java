 ...
 * Key insight: Each preorder element is the root of the current subtree; look it up in the inorder map to find the split point — everything left of mid goes to the left subtree, everything right to the right. A global preIndex advances sequentially through preorder.
 *
 ...
 *
 * Edge Cases Handled: single node, boundary guards (st < 0, end > length, st > end), left-only or right-only skewed chains, duplicate-value-free trees (required for unique reconstruction)
 */
/**
