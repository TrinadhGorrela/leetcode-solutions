 ...
 *
 * Edge Cases Handled: empty tree / null root (returns empty list), single node, one node per level (skewed tree), negative values (uses Integer.MIN_VALUE initialization)
 */
/**
