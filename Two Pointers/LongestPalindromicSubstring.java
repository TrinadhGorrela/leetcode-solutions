 ...
 * Key insight: Every palindrome has a center; testing all 2N-1 centers (N single-char + N-1 char-pair) and expanding
 * outward gives the longest palindrome without needing DP or Manacher's.
 *
 ...
 *
 * Edge Cases Handled: Single character (length 1), all identical characters (entire string), longest palindrome at the
 * very end of the string, even-length palindromes found via pair centers
 */
