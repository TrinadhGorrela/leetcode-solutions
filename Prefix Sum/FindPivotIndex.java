 ...
 * Key insight: Build a left prefix sum and a reversed right prefix sum, each of length N+1 with index 0 = 0; for index
 * i, leftSum[i] is the sum of elements left of i and rightSum[N-i-1] is the sum right of i.
 *
 ...
 *
 * Edge Cases Handled: single element (leftSum[0]=rightSum[0]=0, pivot 0), pivot at index 0 (empty left sum), pivot at
 * last index (empty right sum), no valid pivot (returns -1)
 */
